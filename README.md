#siteholder
> Empty site for future use.

[![Build Status](https://travis-ci.org/IjzerenHein/siteholder.svg?branch=master)](https://travis-ci.org/IjzerenHein/siteholder) [![Dependency Status](https://david-dm.org/IjzerenHein/siteholder.svg)](https://david-dm.org/IjzerenHein/siteholder) [![devDependency Status](https://david-dm.org/IjzerenHein/siteholder/dev-status.svg)](https://david-dm.org/IjzerenHein/siteholder#info=devDependencies)
...
## Release History
 * 2014-07-21   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)